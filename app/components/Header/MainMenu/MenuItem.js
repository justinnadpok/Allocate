...
import DropIcon from 'images/sprite/drop.png';
  ...
  return (
    ...
    >
      {link ?
        ...
        >{text}</Link>
      :
        <span className="mainMenu__link mainMenu__link--hasChildren mainMenu__link--topLevel">{text}<img className="mainMenu__droparrow" src={DropIcon}/></span>
      }
    </div>
  );
};
